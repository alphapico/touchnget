...
@interface HSTimeIntervalFormatter ()
...
@implementation HSTimeIntervalFormatter
...
+ (NSLocale *) currentLocale
{
    ...
    if (languages.count > 0) {
        ...
        //return [[[NSLocale alloc] initWithLocaleIdentifier:@"ms-MY"] autorelease];
