...
@interface PSWebTVWebViewController ()
...
@implementation PSWebTVWebViewController
...
- (void)viewDidLoad
{
    ...
    [button addTarget:self action:@selector(goToWebTVController) forControlEvents:UIControlEventTouchUpInside];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    if ([error code] != NSURLErrorCancelled) {
        ...
        [[self navigationItem] setTitle:@"Web TV"];
