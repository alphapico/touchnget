...
@interface PSBeritaWebViewController ()
...
@implementation PSBeritaWebViewController
...
- (void)viewDidLoad
{
    ...
    [button addTarget:self action:@selector(goToBeritaRSSController) forControlEvents:UIControlEventTouchUpInside];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    if ([error code] != NSURLErrorCancelled) {
        ...
        [[self navigationItem] setTitle:@"Berita"];
