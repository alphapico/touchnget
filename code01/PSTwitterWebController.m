...
@interface PSTwitterWebController ()
...
@implementation PSTwitterWebController
...
- (void)viewDidLoad
{
    ...
    [button addTarget:self action:@selector(goToTwitterController) forControlEvents:UIControlEventTouchUpInside];
