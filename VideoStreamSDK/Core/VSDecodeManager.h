...
typedef enum {
    ...
    kVSDecoderStateCheckingProtocols,
    kVSDecoderStateConnecting,
    kVSDecoderStateConnected,
    kVSDecoderStateConnectionFailed,
    kVSDecoderStateCheckingStreams,
    kVSDecoderStateStreamsChecked,
...
/* conntect to stream URL */
- (VSError)connectWithStreamURL:(NSURL*)url;
